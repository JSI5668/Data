...
# from network.unet import  UNet_2Plus, UNet_my_2
...
def get_argparser():
    ...
    # Datset Options
    parser.add_argument("--data_root", type=str, default='E:/Dacon/Samsung_AI_Challenge/Camera_Invariant_Domain_Adaptation_segmentation/Data/open/my_dataset',
                        help="path to Dataset")  ##crop size 바꿔주기
    parser.add_argument("--dataset", type=str, default='camvid_sample',
                        choices=['camvid_sample'], help='Name of dataset')
    ...
    parser.add_argument("--total_itrs", type=int, default=5485,
    ...
    parser.add_argument("--val_interval", type=int, default=137,
...
def get_dataset(opts):
    ...
    if opts.dataset == 'camvid_sample':
        ...
        # test_dst = Camvid_sample(root=opts.data_root, split='test_image', transform=test_transform)
...
def main():
    ...
    model = smp.UnetPlusPlus(encoder_name="resnet50", encoder_weights="imagenet", in_channels=3, classes=13)
    #
...
###################################################################################
                ...
                if (cur_itrs) % opts.val_interval == 0:
                    ...
                    save_ckpt('E:/Dacon/Samsung_AI_Challenge/Camera_Invariant_Domain_Adaptation_segmentation/Checkpoint/unet_plusplus/latest_%s_%s_os%d.pth' %
                              (opts.model, opts.dataset, opts.output_stride))
                    print("validation...")
                    model.eval()
                    val_score, ret_samples = validate(
                    ...
                    if val_score['Mean IoU'] > best_score:  # save best model
                        ...
                        #           (opts.model, opts.dataset,opts.output_stride))
                        save_ckpt('E:/Dacon/Samsung_AI_Challenge/Camera_Invariant_Domain_Adaptation_segmentation/Checkpoint/unet_plusplus/best_%s_%s_os%d.pth' %
                                  (opts.model, opts.dataset, opts.output_stride))
                    ...
                    save_ckpt('E:/Dacon/Samsung_AI_Challenge/Camera_Invariant_Domain_Adaptation_segmentation/Checkpoint/unet_plusplus/_%s_%s_%s_os%d.pth' %
                ...
                if cur_itrs >= opts.total_itrs:
                    ...
                    df_train_miou.to_csv(
                        'E:/Dacon/Samsung_AI_Challenge/Camera_Invariant_Domain_Adaptation_segmentation/Checkpoint/unet_plusplus/train_miou_2.csv',
                        index=False)
                    df_train_loss.to_csv(
                        'E:/Dacon/Samsung_AI_Challenge/Camera_Invariant_Domain_Adaptation_segmentation/Checkpoint/unet_plusplus/train_loss_2.csv',
                        index=False)
